...
/*	@Override										// metodo che clona la casella, inutilizzato senza AI
	public Casella clone() {
		Casella casella_tmp = new Casella(false);
		
		casella_tmp.riga = riga;
		casella_tmp.colonna = colonna;
		casella_tmp.colore_pedina = colore_pedina;
		casella_tmp.ha_pedina = ha_pedina;
		casella_tmp.ha_dama = ha_dama;
